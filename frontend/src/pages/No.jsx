      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f5] px-10 py-3">
        ...
        <div className="flex flex-1 justify-end gap-8">
          ...
          <div
            ...
            style={{
              backgroundImage:
                'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAyO6crpPeq1k7foaJfs1VBVet29SZAWK_NgMt53zW1VzEkdozfvamq89b-vYeXoZMgoJZ1OWq5v2_HzGQJO0VLt5r2U53JXDpqCa3vAkypanraeIMJ1Vs10uL97pxWa5xBPOuavc7zrp2On1dhPEd8fWlcB0IxVB6gR6yL2fOVJ0mGvA5kYPh8Dowbk6TIGWn2ZZ1Q_z7PCWeedyyYq_v1aDhxI0inoXN3oRC4Acpnrehjy3IcVeaBOyuYLp1stky09azvNwmFtmoJ")'
            }}
          />
        </div>
      </header>
      <div className="gap-1 px-6 flex flex-1 justify-center py-5">
        ...
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="flex items-stretch justify-between gap-4 rounded-xl">
              <div className="flex flex-col gap-1 flex-[2_2_0px]">
                ...
                <p className="text-[#111418] text-base font-bold leading-tight">
                  Send email reminder for upcoming meetings
                </p>
                <p className="text-[#60758a] text-sm font-normal leading-normal">
                  Trigger: 1 hour before meeting, Action: Send email
                </p>
              </div>
              <div
                ...
                style={{
                  backgroundImage:
                    'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBFRWHEjnZyaA1lLLQ0osfv-z3TEPIcdIMupVda2Mu7fqF_4xzYofI7ArCqp0DCI7LaOPHPAwHyY3enDkctd_qyFnF1PovZdD8mCevRnLc5mZLZl4cKZp6l0KXt4aTF4MBodhb4TT6Zc6KSNf3M3bhRdEaZI8jHcom4tOHZSIn1EHyNfk7QZlqv_WGOWCHtx0Xm2-8R9abmGBX_K487JQipenJDYZ9EjOt2JehXX90a4aFEmnSOdnqwPpMYYYiS8vhJC_F3enqyG1K_")'
                }}
              />
            </div>
          </div>
          <div className="p-4">
            <div className="flex items-stretch justify-between gap-4 rounded-xl">
              <div className="flex flex-col gap-1 flex-[2_2_0px]">
                ...
                <p className="text-[#111418] text-base font-bold leading-tight">
                  Schedule follow-up call after initial meeting
                </p>
                <p className="text-[#60758a] text-sm font-normal leading-normal">
                  Trigger: 2 days after meeting, Action: Schedule call
                </p>
              </div>
              <div
                className="w-full bg-center bg-no-repeat aspect-video bg-cover rounded-xl flex-1"
                style={{
                  backgroundImage:
                    'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAJcAQKCbnYd8a1GRwDJ1kLWe3dJAkOknrnIwIIlFYlWx_Bv1ZYzG1xBxeuw2qoGibk48fFrw2JvUIfEhoy0iosle4gj8QmHm2FliEyibEZjyyIzJC2Xd4UJ-3qF8Veiq1ujfU2gXR3goaVLNowS6CKkN86HiH3qompX3yTEGoCr_A29ysN69Sz3jvvc52Zm6CxAXcA06YrmuNjz3PWz708LPJvOjYMASdKlwRy5FKgT3nSiM77y5QWLGkfW6AukEg0CyWkEUAo904n")'
                }}
              />
            </div>
          </div>
          <div className="p-4">
            <div className="flex items-stretch justify-between gap-4 rounded-xl">
              <div className="flex flex-col gap-1 flex-[2_2_0px]">
                ...
                <p className="text-[#111418] text-base font-bold leading-tight">
                  Notify team about new project milestones
                </p>
                <p className="text-[#60758a] text-sm font-normal leading-normal">
                  Trigger: Milestone completion, Action: Send notification
                </p>
              </div>
              <div
                className="w-full bg-center bg-no-repeat aspect-video bg-cover rounded-xl flex-1"
                style={{
                  backgroundImage:
                    'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAop5bkLO3iB_Ks3-UMvdqdElQ1PPoeZvqkYLw7KefIT2LLlj8BEOgqH-zFjGxfGKOw3qLNUMFZ1majRMoBQ_3xsiZX458ujLW708ARP_aHaHj4iKlN6IhIXKKnEJ8ZJ0DsFIdqPx4Ha0sf3KTA_MhKXg5vQlBYZttKnpV71ClB6wqkER9z8aEaDZxQovnLfxqRdzYrtczt4qv5zFJvNzQoOuaO-5tC9K1JlID1D7NlGZeYbmZcc1iMS7mvQw7bC0ZPd9YrlUfnfHxe")'
                }}
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 bg-white px-4 min-h-[72px] py-2">
            <div
              className="text-[#111418] flex items-center justify-center rounded-lg bg-[#f0f2f5] shrink-0 size-12"
              data-icon="Clock"
              data-size="24px"
              data-weight="regular"
            >
